...
async def to_code(config):
    ...
    if lib_dir.exists():
        # Find the prebuilt .a files (named libsnapspot-idf<ver>-esp32s3.a etc.)
        snapspot_libs = sorted(lib_dir.glob("libsnapspot-idf*-esp32s3.a"))
        cspot_libs    = sorted(lib_dir.glob("libcspot-idf*-esp32s3.a"))
