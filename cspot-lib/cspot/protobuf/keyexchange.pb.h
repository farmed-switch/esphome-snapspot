...
#ifndef PB_COMPONENTS_CSPOT_CSPOT_LIB_CSPOT_PROTOBUF_KEYEXCHANGE_PB_H_INCLUDED
#define PB_COMPONENTS_CSPOT_CSPOT_LIB_CSPOT_PROTOBUF_KEYEXCHANGE_PB_H_INCLUDED
#include <pb.h>
