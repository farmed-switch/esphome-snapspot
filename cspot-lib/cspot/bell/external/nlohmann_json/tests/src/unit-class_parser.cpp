...
bool accept_helper(const std::string& s)
{
    ...
    json::parser_callback_t const cb = [](int  , json::parse_event_t  , json&  ) noexcept
    {
        return true;
    };
...
TEST_CASE("parser class")
{
    SECTION("parse")
    {
        ...
        SECTION("string")
        {
            ...
            SECTION("errors")
            {
                ...
                CHECK_THROWS_WITH_AS(parser_helper("\"\x00\""), "[json.exception.parse_error.101] parse error at line 1, column 2: syntax error while parsing value - invalid string: missing closing quote; last read: '\"'", json::parse_error&);
    ...
    SECTION("tests found by mutate++")
    {
        ...
        {
            json::parser_callback_t const cb = [](int  , json::parse_event_t event, json&  ) noexcept
            {
    ...
    SECTION("callback function")
    {
        ...
        {
            json j_object = json::parse(s_object, [](int  , json::parse_event_t  , const json&  ) noexcept
            {
                return true;
            });
            ...
            json j_array = json::parse(s_array, [](int  , json::parse_event_t  , const json&  ) noexcept
            {
                return true;
            });
        ...
        {
            json const j_object = json::parse(s_object, [](int  , json::parse_event_t  , const json&  ) noexcept
            {
                return false;
            });
            ...
            json const j_array = json::parse(s_array, [](int  , json::parse_event_t  , const json&  ) noexcept
            {
                return false;
            });
        ...
        {
            json j_object = json::parse(s_object, [](int  , json::parse_event_t event, const json & j) noexcept
            {
            ...
            json j_array = json::parse(s_array, [](int  , json::parse_event_t event, const json & j) noexcept
            {
                return event != json::parse_event_t::value || j != json(2);
            });
        ...
        SECTION("filter object in array")
        {
            ...
            json j_filtered2 = json::parse(structured_array, [](int  , json::parse_event_t e, const json&  ) noexcept
            {
        ...
        SECTION("filter specific events")
        {
            ...
            {
                {
                    json j_object = json::parse(s_object, [](int  , json::parse_event_t e, const json&  ) noexcept
                    {
                ...
                {
                    json j_array = json::parse(s_array, [](int  , json::parse_event_t e, const json&  ) noexcept
                    {
                        static bool first = true;
        ...
        SECTION("special cases")
        {
            ...
            json j_empty_object = json::parse("{}", [](int  , json::parse_event_t e, const json&  ) noexcept
            {
                return e != json::parse_event_t::object_end;
            });
            CHECK(j_empty_object == json());

            json j_empty_array = json::parse("[]", [](int  , json::parse_event_t e, const json&  ) noexcept
            {
