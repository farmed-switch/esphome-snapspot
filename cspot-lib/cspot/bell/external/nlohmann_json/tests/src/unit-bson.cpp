...
TEST_CASE("BSON")
{
    ...
    SECTION("objects")
    {
        ...
        SECTION("Some more complex document")
        {
            ...
            {
                  0x4f, 0x00, 0x00, 0x00,
                  0x01, 'd',  'o',  'u',  'b',  'l',  'e',  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x45, 0x40,
                  0x01, 'e',  'n',  't',  'r',  'y',  0x00, 0xcd, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0x10, 0x40,
                  0x10, 'n',  'u',  'm',  'b',  'e',  'r',  0x00, 0x39, 0x30, 0x00, 0x00,
                  0x03, 'o',  'b',  'j',  'e',  'c',  't',  0x00,
                  0x17, 0x00, 0x00, 0x00,
                 0x02, 's',  't',  'r',  'i',  'n',  'g', 0x00, 0x06, 0x00, 0x00, 0x00, 'v', 'a', 'l', 'u', 'e', 0,
                 0x00,
                  0x00
            };
