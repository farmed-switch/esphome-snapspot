...
#define PE_MAX_FS_KHZ               16

#define PE_MAX_NB_SUBFR             4
#define PE_SUBFR_LENGTH_MS          5
...
#define PE_MAX_LAG_MS               18
#define PE_MIN_LAG_MS               2
...
#define PE_SHORTLAG_BIAS            0.2f
#define PE_PREVLAG_BIAS             0.2f
