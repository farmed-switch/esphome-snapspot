...
TEST(chrono_test, format_tm) {
  ...
  std::vector<std::tm> tm_list = {
      make_tm(1975, 12, 29, 12, 14, 16),
      make_tm(1977, 1, 2, 12, 14, 16),
      make_tm(1999, 12, 27, 12, 14, 16),
      make_tm(1999, 12, 31, 12, 14, 16),
      make_tm(2000, 1, 1, 12, 14, 16),
      make_tm(2000, 1, 2, 12, 14, 16),
      make_tm(2000, 1, 3, 12, 14, 16)
  };
